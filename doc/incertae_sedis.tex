...
Note that this example also exposes a lack of consistency in
Equation (\ref{eq:exsetformonea}) that rears its head when attempting to
iteratively revise placement of \emph{incertae sedis} taxa in the taxonomy
on successive supertree builds.
% without retention of additional information.

...
\subsubsection{Split-based semantics}
...
\begin{align*}
\mathcal{E}(n) & =\left[\mathcal{I}(s)\big|a\in n+ancestors(n),s\in siblings(a)\right]\\
 & =\left[\mathcal{I}(s)\big|s\in siblings(n)\right]\cup\left[\mathcal{I}(s)\big|a\in ancestors(n),s\in siblings(a)\right]\\
 & =\left[\mathcal{I}(s)\big|s\in siblings(n)\right]\cup\mathcal{E}(parent(n)) \label{eq:exclude-set-formula-traditional}
\end{align*}
...
\begin{align*}
\mathcal{E}(n) & =\left[\mathcal{I}(s)\big|a\in n+ancestors(n),s\in siblings(a),s\text{ not \emph{incertae sedis}}\right]\\
 ...
 & =\left[\mathcal{I}(s)\big|s\in siblings(n),s\text{ not \emph{incertae sedis}}\right]\cup\mathcal{E}(parent(n)).\label{eq:exclude-set-formula-1a}
\end{align*}
...
\subsection{Cases that this semantics can handle}

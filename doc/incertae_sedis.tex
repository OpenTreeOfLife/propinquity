...
\bdrcomment{I duplicated section \ref{conflict} to here, since we might want
  to discuss Figure \ref{fig:Handling-incertae-sedis} in the intro to answer
  why anybody would care.  Or not.  But note that the section on the ``naive approach''
  asks basically this question.}
...
% \bdrcomment{ I think we would currently lose about 10 taxa }    

\bdrcomment{The reason why we don't do the naive thing is currently in section \ref{conflict}}

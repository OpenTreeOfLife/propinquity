...
The decomposition partitioning the list of
...
be performed on smaller, relabeled trees.
...
In previous work, taxa in $\mathcal{U}$ were all pruned from
...
If the order of trees is set to be (with
...
statement about which other taxa might include \emph{x}.
Detailed
...
such information on the scale of the entire OTT.
Here we consider a
...
\mthcomment{MTH: I don't understand this.}

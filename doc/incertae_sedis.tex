...
First, this approach results in a less-resolved tree.  While input trees are
...
allow us to note that $C$ has been placed within $A$.  In contrast, the
synthesis tree in Fig. \ref{fig:Handling-incertae-sedis}d retains the label for
$A$, which allows us to resolve taxonomic uncertainty by infering that
\emph{incertae sedis} taxon $C$ has been placed within $A$.

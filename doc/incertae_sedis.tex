...
\begin{eqnarray*}
 ...
 & =\left[\mathcal{I}(s)\big|s\in siblings(n)\right]\cup\mathcal{E}(parent(n)) \label{eq:exsetformtraditional}
\end{eqnarray*}
...
& =\left[\mathcal{I}(s)\big|s\in siblings(n),s\text{ not \emph{incertae sedis}}\right]\cup\mathcal{E}(parent(n)).

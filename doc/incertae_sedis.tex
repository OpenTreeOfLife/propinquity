...
\author{Benjamin D. Redelings and Mark T. Holder} maketitle
...
\begin{comment} MTH:
I don't understand this \end{comment} \item The semantics of an
...
\begin{enumerate} \item create a monotypic parent $p(x)$ of $x$, and
assign $n_{max}$ to $p(x)$ \item continue handling name clashes at $x$
with the set of possible names reduced to $N-n_{max}$. \end{enumerate}
...
\bibliographystyle{upmplainnat} bibliography{otcetera}

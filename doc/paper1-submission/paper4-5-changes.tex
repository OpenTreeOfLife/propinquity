...
%DIF ADD paper5.tex   Mon Jan 23 17:06:15 2017
...
%DIF >  TODO: add stuff to paper
%DIF >  R1.2 Mention that applying ranks to trees instead of nodes is problematic.
%DIF >       Mention transparency?
%DIF >  R2.1: Add paragraph mentioning MRP, MinCut, and how they are different. - 1.1.6
\DIFaddbegin 
...
\DIFadd{We also consider matrix representation with parsimony (MRP) and MinCut.
...
\DIFadd{A number of other supertree methods exist, including Matrix
Representation with Parsimony (MRP) and MinCut.  MRP
%DIF >  http://currents.plos.org/treeoflife/article/reweaving-the-tapestry-a-supertree-of-birds/

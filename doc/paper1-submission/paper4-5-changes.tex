...
%DIF ADD paper5.tex   Mon Jan 23 17:57:11 2017
...
by $\summaryTree$.
For any such node $j$ there is a set of taxa
that are mapped to the tips that descend from the node. This set of taxa is the }\DIFdelend \DIFaddbegin \DIFadd{Cutting any edge }\textbf{\DIFadd{$j$ }}\DIFadd{of a rooted tree induces a bi-partition
...
\par\end{centering}
\caption{Unpruned tree with internal taxa. \DIFdelbeginFL \DIFdelFL{Nodes E2, F2, and D }\DIFdelendFL \DIFaddbeginFL \DIFaddFL{Taxa unsampled in phylogenetic
statements }\DIFaddendFL have been \DIFdelbeginFL \DIFdelFL{re-added
}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{added }\DIFaddendFL to the \DIFaddbeginFL \DIFaddFL{grafted }\DIFaddendFL tree \DIFdelbeginFL \DIFdelFL{. The nodes E and F are no longer monotypic}\DIFdelendFL \DIFaddbeginFL \DIFaddFL{shown
in figure \ref{fig:grafted-solution}}\DIFaddendFL .}
\end{figure}

...
\begin{abstract}
We present a new supertree method that enables rapid construction of a
...
method by assessing their performance on input
...
\begin{figure}
\begin{centering}
\includegraphics[height=0.70\paperheight]{Fig3.pdf}
\par\end{centering}
...
\begin{figure}
\subfloat[Tree 1]{\includegraphics[scale=0.4]{Fig5a}

}\hfill{}\subfloat[Tree 2]{\includegraphics[scale=0.4]{Fig5b}

}\hfill{}\subfloat[Pruned taxonomy tree $\protect\prunedTaxonomy$]{\includegraphics[scale=0.4]{Fig5c}

}

\caption{Exemplified input trees and taxonomy tree from Fig. \ref{fig:cleaned-phylo-example}.
...
\begin{figure}
  \subfloat[Subproblem \emph{ABCD}]{\includegraphics[width=0.3\textwidth]{Fig6a}%
    \hfill{}\includegraphics[width=0.3\textwidth]{Fig6b}%
    \hfill{}\includegraphics[width=0.3\textwidth]{Fig6c}

}

  \subfloat[Subproblem \emph{root}]{\includegraphics[width=0.3\textwidth]{Fig6d}%
    \hfill{}\includegraphics[width=0.3\textwidth]{Fig6e}%
    \hfill{}\includegraphics[width=0.3\textwidth]{Fig6f}

}

\caption{Subproblems generated from the exemplified trees shown in Fig. \ref{fig:exemplify-example}.
...
\end{figure}
\begin{figure}
\subfloat[]{\includegraphics[scale=0.57]{Fig7a}

}\hfill{}\subfloat[]{\includegraphics[scale=0.57]{Fig7b}

}\hfill{}\subfloat[]{\includegraphics[scale=0.57]{Fig7c}

}

\hfill{}\subfloat[]{\includegraphics[scale=0.57]{Fig7d}

}\hfill{}\subfloat[]{\includegraphics[scale=0.57]{Fig7e}
...
\caption{Solutions to the subproblems depicted in Fig. \ref{fig:subproblems-example}}

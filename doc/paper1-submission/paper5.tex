...
% TODO: add stuff to paper
% R1.2 Mention that applying ranks to trees instead of nodes is problematic.
%      Mention transparency?
% R2.1: Add paragraph mentioning MRP, MinCut, and how they are different. - 1.1.6
...
% http://currents.plos.org/treeoflife/article/reweaving-the-tapestry-a-supertree-of-birds/

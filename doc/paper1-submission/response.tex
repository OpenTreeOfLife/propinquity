...
%Our approach is somewhat novel in that we replace a kind of pseudo-estimation framework with a curation-based framework in which curators can influence conflict resolution by specifying high ranks for trees containing a desired relationship:

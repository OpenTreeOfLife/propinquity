...
corresponds to the split $B1\,B2\,C\,|\bullet\,Y$, and is child taxon
...
this problem by introducing a monotypic parent, and applying $A$
to the newly created parent node (Fig. \ref{fig:Multiple-names-can}c).
\begin{figure}
...
Not all cases where multiple names apply to a single node can be resolved
in this way.

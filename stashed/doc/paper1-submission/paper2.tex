%% LyX 2.2.0 created this file.  For more info, see http:____www.lyx.org__.
...
\begin{figure}
\subfloat[Input tree 1]{\includegraphics[scale=0.6]{Figures__toy_pairwise_compat__abc}

}\hfill{}\subfloat[Input tree 2]{\includegraphics[scale=0.6]{Figures__toy_pairwise_compat__acd}

}\hfill{}\subfloat[Input tree 3]{\includegraphics[scale=0.6]{Figures__toy_pairwise_compat__bcd}

}

\subfloat[Summary tree]{\includegraphics[scale=0.6]{Figures__toy_pairwise_compat__s12}

}\hfill{}\subfloat[Summary tree]{\includegraphics[scale=0.6]{Figures__toy_pairwise_compat__s13}

}\hfill{}\subfloat[Summary tree]{\includegraphics[scale=0.6]{Figures__toy_pairwise_compat__s23}
...
\begin{figure}
\begin{centering}
\includegraphics[height=0.75\paperheight]{paper-pipeline-tools.pdf}
\par\end{centering}
...
\end{figure}
\begin{figure}
\subfloat[]{\includegraphics[scale=0.6]{Figures__uncontested_worsens_score__ab1c}

}\hfill{}\subfloat[]{\includegraphics[scale=0.6]{Figures__uncontested_worsens_score__acb2}

}\hfill{}\subfloat[]{\includegraphics[scale=0.6]{Figures__uncontested_worsens_score__tax}

}

\hfill{}\subfloat[]{\includegraphics[scale=0.6]{Figures__uncontested_worsens_score__opt}

}\hfill{}\subfloat[]{\includegraphics[scale=0.6]{Figures__uncontested_worsens_score__returned}
...
\begin{figure}
\hfill{}\subfloat[Solution to subproblem \emph{ABCD}]{\includegraphics[scale=0.45]{Figures__subproblem_solutions__ott14\lyxdot tre}

}\hfill{}\subfloat[Solution to subproblem \emph{root}]{\includegraphics[scale=0.45]{Figures__subproblem_solutions__ott17\lyxdot tre}
...
\begin{center}
\includegraphics[scale=0.4]{example3__cleaned_ott-labels\lyxdot tre}
\par\end{center}%
\end{minipage}
\par\end{centering}
...
\begin{minipage}[c][1\totalheight][t]{0.45\columnwidth}%
\begin{center}
\includegraphics[scale=0.4]{example3__grafted_solution-labels\lyxdot tre}
\par\end{center}%
\end{minipage}
\par\end{centering}
}\hfill{}
...
\includegraphics[scale=0.4]{example3__unprune-old-labels\lyxdot tre}
\par\end{centering}
}\hfill{}\subfloat[Unpruned tree with MRCA-attachment]{\begin{centering}
\includegraphics[scale=0.4]{example3__unprune-new-labels2\lyxdot tre}
\par\end{centering}
}
\par\end{centering}
